...
export const uz: Partial<Record<TranslationKey, string>> = {
  ...
  "home.empty.invited": "Sizni hech qayerga taklif qilishmagan.",
  ...
  "booking.guest_badge": "Siz mehmonsiz",
  ...
  "booking.error.no_slots_today": "Bugun bo'sh vaqt yo'q :(",
  "booking.error.slots_failed": "Bandlikni olishda xatolik. Qayta urinib ko'ring.",

  "create.title": "Yangi uchrashuv",
  "create.field.name": "Nomi",
  "create.field.start": "Boshlanishi",
  "create.field.end": "Tugashi",
  ...
  "create.error.end_after_start": "Tugash vaqti boshlanishidan keyin bo'lishi kerak.",
  ...
  "register.error.first_name_format": "Ism — lotin alifbosi, katta harf bilan (masalan, Alisher).",
