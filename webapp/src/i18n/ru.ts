export const ru = {
  ...
  "invitations.public_link.subtitle": "Любой, у кого есть ссылка, вступит в пространство автоматически — **если** пространство не привязано к Telegram-группе.\n🔒 Чтобы ограничить вступление только участниками группы — привяжите её в разделе «Общее».\n\nПосле обновления старая ссылка перестаёт работать.",
  ...
  "general.bind.hint_bound": "Группа привязана.\n📅 Уведомления о встречах приходят туда.\n🔒 По публичной ссылке могут вступать только участники этой группы.",
